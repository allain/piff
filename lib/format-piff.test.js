...
describe('format-piff', () => {
  ...
  describe('expressions', () => {
    ...
    it('correctly handles member expression', () =>
      expect(format('a.b(1,2,3)')).toEqual('a.b(1, 2, 3)\n'))
  })
  ...
  describe('wrapping', () => {
    it('wraps function call arguments if they are getting too long', () =>
      expect(
        format(
    ...
    it('wraps function declaration arguments if they are getting too long', () =>
      expect(
        format(
          'fn a(a23456789,b23456789,c23456789,d23456789,e23456789,f23456789,g23456789,h23456789) {}'
        )
      ).toEqual(
        [
          'fn a(',
    ...
    it('wraps function expression arguments if they are getting too long', () =>
      expect(
        format(
          'a = fn (a23456789,b23456789,c23456789,d23456789,e23456789,f23456789,g23456789,h23456789) {}'
        )
      ).toEqual(
        [
          'a = fn (',
    ...
    it('wraps interface method declarations if they are getting too long', () =>
      expect(
        format(
          'interface A { a(a23456789,b23456789,c23456789,d23456789,e23456789,f23456789,g23456789,h23456789) }'
        )
      ).toEqual(
        [
          'interface A {',
    ...
    it('wraps array literals if they are getting too long', () =>
      expect(
        format(
    ...
    it('does not wrap short nested literals', () =>
      expect(
        format(
          '[123456789,123456789,123456789,[123456789,123456789],123456789,123456789,123456789]'
        )
    ...
    it('does wrap when long nested literals', () =>
      expect(
        format(
          '[123456789,[123456789,123456789,123456789,123456789,123456789,123456789],123456789]'
        )
