...
let generators = {
  ...
  TryStatement: n => {
    return [
      ...
      ' ',
      n.block.php,
      n.handler ? n.handler.php : null,
      n.finalizer ? [' ', 'finally', ' ', n.finalizer.php] : null
    ]
  },

  CatchClause: n => {
    return ['catch', '(', n.paramClass.php, ' ', n.param.php, ')', n.body.php]
  },
